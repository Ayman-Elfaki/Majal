...
public class ValueObjectEfCoreConfigurationTemplate(ValueObjectEfCoreData[] valueObjects) : BaseTemplate
{
    public override string TransformText()
    {
        ...
        foreach (var valueObject in valueObjects)
        {
            ...
            PushIndent();
            if (valueObject is { MaxLength: { } maxLength, GenericType: "string" })
            {
                WriteLine($".HaveMaxLength({maxLength})");
            }

            WriteLine($".HaveConversion<{fullTypeName}.{ValueObjectEfCoreConverterTemplate.EfCoreValueConverterTypeName}>();");
            PopIndent();
            WriteLine("");
        }
