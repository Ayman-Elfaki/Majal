...
namespace Majal.Common.CodeFixes;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EntityAttributeRequiredCodeFix)), Shared]
public sealed class EntityAttributeRequiredCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(EntityAttributeRequiredAnalyzer.DiagnosticId);
